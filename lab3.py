...
for img_path in images:
    ...
    flat_img_mat_R = img_mat_R.ravel()
    flat_img_mat_B = img_mat_B.ravel()
    flat_img_mat_G = img_mat_G.ravel()
    ...
    colour_samples = np.column_stack((flat_img_mat_R,flat_img_mat_B,flat_img_mat_G))
	...
	ms_labels = ms_labels.reshape(x,y)
